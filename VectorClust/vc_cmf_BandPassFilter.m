function varargout = vc_cmf_BandPassFilter(varargin)
%VC_CMF_BANDPASSFILTER M-file for vc_cmf_BandPassFilter.fig
%      VC_CMF_BANDPASSFILTER, by itself, creates a new VC_CMF_BANDPASSFILTER or raises the existing
%      singleton*.
%
%      H = VC_CMF_BANDPASSFILTER returns the handle to a new VC_CMF_BANDPASSFILTER or the handle to
%      the existing singleton*.
%
%      VC_CMF_BANDPASSFILTER('Property','Value',...) creates a new VC_CMF_BANDPASSFILTER using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to vc_cmf_BandPassFilter_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      VC_CMF_BANDPASSFILTER('CALLBACK') and VC_CMF_BANDPASSFILTER('CALLBACK',hObject,...) call the
%      local function named CALLBACK in VC_CMF_BANDPASSFILTER.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help vc_cmf_BandPassFilter

% Last Modified by GUIDE v2.5 12-Apr-2013 16:12:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vc_cmf_BandPassFilter_OpeningFcn, ...
                   'gui_OutputFcn',  @vc_cmf_BandPassFilter_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before vc_cmf_BandPassFilter is made visible.
function vc_cmf_BandPassFilter_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = vc_cmf_BandPassFilter_OutputFcn(hObject, eventdata, handles)
...
handles.Low = str2double(get(handles.text_Low,'String'));
handles.High = str2double(get(handles.text_High,'String'));
...
function text_Low_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function text_Low_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_Low (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function text_High_Callback(hObject, eventdata, handles)
% hObject    handle to text_High (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of text_High as text
%        str2double(get(hObject,'String')) returns contents of text_High as
%        a double

% --- Executes during object creation, after setting all properties.
function text_High_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_High (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
