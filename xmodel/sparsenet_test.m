...
sn.kernelstd = 12.5; % set to 1/8 for instantaneous rewards
...
sn.wLstd      = 0%0.2; %standard deviation of LMAN weights
sn.istr       = sn.lmanoffset + 1.5 * sn.lmanstd;
sn.latinhib   = 6; % down from 3

sn.LTPrate = 0.001%0.2; % down from 2e-1 with lateral inhibition of 3
sn.LTDrate = 0;%0.008;
