...
MinReading = 6.8; % just based on looking at values I got for these coolers
MeanReadings = MaxReading - mean(LightReadings,1);
...
%%
figure; 
errorbar(LightPerBird, MeanMat, StdMat,'.')
text(LightPerBird, MeanMat, birdnames)
xlabel('light'); ylabel('maturity')
