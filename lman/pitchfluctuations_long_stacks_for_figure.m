...
targetsyllables{5} = 2;
timewindows{5} = [.085 .120];

birdnames{6} = 'black401';
expernames{6} = '2010-12-20';
targetsyllables{6} = 1;
timewindows{6} = [.08 .160]; % pitch slopes downward

birdnames{7} = 'mes010';
expernames{7} = '2011-02-26';
targetsyllables{7} = 2;
timewindows{7} = [.095 .145];
...
for n = 1:length(birdnames)
    ...
    savefile = ['C:\stetner\data\pitchfluctuations\long_stacks_for_figure\' birdnames{n} '_nodc'];
