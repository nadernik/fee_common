function final_noise = generate_lman_noise_mes010(rows, cols, debugging)
% GENERATE_LMAN_NOISE_MES010 generates random noise with power spectrum
% matching measured pitch fluctuations from bird named mes010
%
...
frequency_domain_filter = f * ones(1, cols);
