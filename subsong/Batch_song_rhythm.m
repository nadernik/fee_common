function Batch_song_rhythm(fileName,Category,fileNum)
%%% Song rhythm batch for all categories except cooling
%%% Batch_song_rhythm(birdName,pathName,Category,fileNum)
...
if Category==5 || Category==6
    error('Run Batch_song_rhythm_cooling instead!')
end
...
if nargin > 2 % file number specified
